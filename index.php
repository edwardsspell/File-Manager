                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label=" File Manager">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="/" target="_blank" class="float-right text-muted">File Manager</a></div>
        <?php else: ?>
            <div class="col-12"><a href="/" target="_blank" class="float-right text-muted">File Manager</a></div>
        <?php endif; ?>
    </div>
